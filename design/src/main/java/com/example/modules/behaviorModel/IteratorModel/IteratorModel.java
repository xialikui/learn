package com.example.modules.behaviorModel.IteratorModel;
...
public class IteratorModel {
    ...
    //电影节目的迭代器
    public static class FilmMenuIterator implements Iterator{
        MenuItem[] menuItems;
        int position = 0;
    ...
    //电视界面的迭代器
    public static class TVChanneMenuIterator implements Iterator{
    ...
    public static class FilmMenu implements TelevisionMenu{
    ...
    public static class TVChanneMenu implements TelevisionMenu{
        List<MenuItem> menuItems;
